                                    ...
                                    <form name="signinform" class="row sign-in-form">
                                        ...
                                        <div class="col-md-12">
                                            <div class="reset-password-link">
                                                <p class="p-sm"><NuxtLink to="/template/reset-password" class="color--theme">Forgot your password?</NuxtLink></p>
                                            </div>
                                        </div>
                                        <!-- Form Submit Button -->
                                        <div class="col-md-12">
                                        ...
                                        <!-- Sign Up Link -->
                                        <div class="col-md-12">
                                            <p class="create-account text-center">Don't have an account? <NuxtLink to="/template/signup-2" class="color--theme">Sign up</NuxtLink></p>
                                        </div>
                                    </form>
                                </div>
                            </div>
