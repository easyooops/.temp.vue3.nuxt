                    ...
                    <div class="register-page-form">
                        ...
                        <div class="col-md-12">
                            <div class="register-form-title">
                                ...
                                <p class="p-md">Already have an account? <NuxtLink to="/template/login-1" class="color--theme">Log In</NuxtLink></p>
                            </div>
                        </div>
                        <!-- SIGN UP FORM -->
                        <form name="signupform" class="row sign-up-form">
                            ...
                            <div class="col-md-12">
                                <div class="form-data">
                                    <span
                                        >By clicking “Create Account”, you agree to our <NuxtLink to="/template/terms">Terms</NuxtLink> and that you have read our
                                        <NuxtLink to="/template/privacy"> Privacy Policy</NuxtLink>
                                    </span>
                                </div>
                            </div>
                            <!-- Form Submit Button -->
