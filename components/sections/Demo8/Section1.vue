            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6 col-lg-5">
                    <div id="hero-8-form" class="r-10 wow fadeInLeft">
                        ...
                        <!-- Notice Text -->
                        <p class="p-sm">By submitting this form, you accept our <NuxtLink to="/template/terms">Terms of Service</NuxtLink> and <NuxtLink to="/template/privacy">Privacy Policy</NuxtLink></p>
                    </div>
                    <!-- END FORM -->
                </div>
