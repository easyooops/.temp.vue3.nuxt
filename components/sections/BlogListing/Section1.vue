                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-md-6">
                        <div class="blog-post-txt">
                            ...
                            <!-- Post Link -->
                            <h3 class="s-38 w-700">
                                <NuxtLink to="/template/single-post">Congue magna tempor and ipsum Martex sapien turpis laoreet augue </NuxtLink>
                            </h3>
                            <!-- Text -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <!-- Post Link -->
                                <h6 class="s-20 w-700">
                                    <NuxtLink to="/template/single-post">Aliqum mullam porta blandit: lacus and sapien gravida </NuxtLink>
                                </h6>
                                <!-- Text -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <!-- Post Link -->
                                <h6 class="s-20 w-700">
                                    <NuxtLink to="/template/single-post">Porttitor cursus fusce neque CEO egestas cursus magna sapien and suscipit ipsum </NuxtLink>
                                </h6>
                                <!-- Text -->
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <!-- Post Link -->
                                <h6 class="s-20 w-700">
                                    <NuxtLink to="/template/single-post">Cubilia laoreet ipsum augue eget egestas Martex magna</NuxtLink>
                                </h6>
                                <!-- Text -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <!-- Post Link -->
                                <h6 class="s-20 w-700">
                                    <NuxtLink to="/template/single-post">Phasellus blandit justo undo aliquam vitae molestie nunc sapien augue justo aliquet </NuxtLink>
                                </h6>
                                <!-- Text -->
                                <p>Aliqum mullam ipsum vitae and blandit vitae tempor sapien and donec lipsum</p>
                                <!-- Post Meta -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <!-- Post Link -->
                                <h6 class="s-20 w-700">
                                    <NuxtLink to="/template/single-post">Blandit justo phasellus undo aliquam diam molestie vitae </NuxtLink>
                                </h6>
                                <!-- Text -->
                                <p>Luctus vitae egestas augue and ipsum ultrice quisque in cursus lacus feugiat egets congue ultrice sagittis laoreet</p>
                                <!-- Post Meta -->
                    ...
                    <div class="col-md-12 col-lg-4">
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <!-- Post Link -->
                                <h6 class="s-20 w-700">
                                    <NuxtLink to="/template/single-post">Cursus porttitor fusce neque CEO egestas cursus magna sapien and ipsum suscipit </NuxtLink>
                                </h6>
                                <!-- Text -->
                                ...
                                <div class="col-md-6 order-last order-md-2">
                                    <div class="blog-post-txt color--white">
                                        ...
                                        <h4 class="s-34 w-700 mb-20">
                                            <NuxtLink to="/template/single-post">Lipsum sodales sapien Martex aliquet blandit augue gravida posuere </NuxtLink>
                                        </h4>
                                        <!-- Text -->
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="blog-post mb-40 wow fadeInUp clearfix">
                            ...
                            <div class="blog-post-txt">
                                ...
                                <!-- Post Link -->
                                <h6 class="s-20 w-700">
                                    <NuxtLink to="/template/single-post">Phasellus blandit justo undo aliquam diam vitae molestie </NuxtLink>
                                </h6>
                                <!-- Text -->
                                <p>Egestas luctus vitae augue and ipsum ultrice quisque in cursus lacus feugiat congue diam ultrice laoreet sagittis</p>
                                <!-- Post Meta -->
