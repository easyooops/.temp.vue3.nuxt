                        ...
                        <div id="pt-1-1" class="project-details">
                            ...
                            <div class="project-preview r-10">
                                ...
                                <div class="project-link ico-35 color--white">
                                    <NuxtLink to="/template/project-details" title=""><span class="flaticon-visibility"></span></NuxtLink>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="more-projects wow fadeInUp">
                        <NuxtLink to="/template/projects" class="btn btn--theme hover--tra-black">See more projects</NuxtLink>
                    </div>
                </div>
            </div>
        </div>
