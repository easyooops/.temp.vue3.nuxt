                        ...
                        <div class="col-md-8">
                            <div class="banner-7-txt text-center">
                                ...
                                <div class="btns-group">
                                    <NuxtLink to="/template/signup-1" class="btn r-04 btn--theme hover--theme">Get srarted - it's free </NuxtLink>
                                    <NuxtLink to="/template/pricing-1" class="btn r-04 btn--tra-black hover--theme">Discover pricing</NuxtLink>
                                </div>
                                <!-- Button Text -->
